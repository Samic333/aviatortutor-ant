...
export default async function BookingPage({ params }: { params: { id: string } }) {
    ...
    // Determine if we need to pick a time
    const needsTimeSelection = !cls.startDate;
                    ...
                    <form action={createBookingAndCheckout}>
                        ...
                        {needsTimeSelection ? (
                            ...
                            <div className="flex items-center gap-2 mb-4 p-3 bg-muted rounded-md">
                                ...
                                <input
                                    type="hidden"
                                    name="scheduledTime"
                                    value={new Date(cls.startDate!).toISOString()}
                                />
                            </div>
                        )}
                        ...
                        <div className="pt-4 border-t">
                            <div className="flex justify-between items-center mb-4">
                                <span>Total</span>
                                <span className="font-bold text-xl">${cls.price}</span>
                            </div>
