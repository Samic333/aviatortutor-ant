...
import { CreateTicketForm } from "@/components/student/CreateTicketForm"; // Reusing component
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Get help with platform issues or disputes.</p>
                </div>
                <CreateTicketForm />
            </div>
